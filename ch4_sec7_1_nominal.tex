...
%
%  Requires: the three variants each run with  USE_OCCLUDER = false.
%            Results are read off the terminal output and the ViSP plot
%            windows, so capture them before closing the run.
% ======================================================================
