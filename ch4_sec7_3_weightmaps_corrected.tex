...
%
%  --------------------------------------------------------------------
%  A. FIRST, SOMETHING THAT CHANGES MY ADVICE ON 4.7.2.
%     These maps are at iteration 600 of the OCCLUDED run. So that run
%     does reach 600, and the consoles you sent me were simply a snapshot
%     at 400. Do not rerun anything: scroll the occluded log to iteration
%     600 and quote those pose values in Table~\ref{tab:Occlusion_pose}.
%     That removes the mismatch with the nominal table at a stroke, and it
%     also answers whether Variant 3's translation gap closes, since its
%     commanded velocity at 400 was still twenty times the other two.
%     Send me the three iteration-600 blocks and I will update 4.7.2.
%
%  --------------------------------------------------------------------
...
among whatever residuals remain.
