...
N_{e}^{0.8}$, so it falls from $\lambda\simeq53$ at the first iteration towards
order unity, and since the commanded velocity is itself proportional to the
residual, $\norm{\mathbf{V}_c}$ decays roughly as the cube of the misalignment
and vanishes while a small misalignment remains. That misalignment is dominated
